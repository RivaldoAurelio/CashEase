...
class _BagiUangPageState extends State<BagiUangPage> {
  ...
  void _showRequestDialog(String contactName) {
    ...
    showDialog(
      ...
      builder: (ctx) {
        return AlertDialog(
          title: Text('${l10n.requestMoney} $contactName'),
          content: Column(
            ...
            ElevatedButton(
              onPressed: () {
                ...
                if (amountText.isEmpty || int.tryParse(amountText) == null) {
                  ...
                  ScaffoldMessenger.of(context).showSnackBar(
                    SnackBar(
                      content: Text(l10n.enterValidNominal),
                    ),
                  );
                  return;
                }
  ...
  Widget _buildContactsSection(AppLocalizations l10n) {
