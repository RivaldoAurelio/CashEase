...
class _HomeState extends State<Home> {
  ...
  List<Widget> get _pages => [
        ...
        const QrisPage(),
        const Pocket(),
        // MODIFIKASI: Mengirimkan userPhone ke ProfilePage
...
class _HomeHeaderBodyState extends State<HomeHeaderBody> {
  ...
  // MODIFIKASI: Load balance dari Firestore
  Future<void> _loadBalance() async {
    ...
    setState(() {
      if (userMap != null) {
        // Pastikan field 'balance' ada dan bertipe int
      ...
      children: [
        ...
        _buildHeaderButton(Icons.add, 'Isi Saldo', () async {
          ...
          if (added != null && added > 0) {
            // MODIFIKASI: Gunakan Firestore addTransaction untuk TopUp
    ...
    final List<Map<String, dynamic>> menuItems = [
      ...
      },
      {
        ...
        'onTap': () async {
          ...
          if (added != null && added > 0) {
            // MODIFIKASI: Gunakan Firestore addTransaction
            await _firestoreService.addTransaction(
              userPhone: widget.phoneNumber,
              type: 'topup',
              amount: added,
