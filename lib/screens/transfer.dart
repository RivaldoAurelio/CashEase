...
class _TransferPageState extends State<TransferPage> {
                ...
                if (confirmed == true) {
                  ...
                  if (verified == true) {
                    ...
                    if (success) {
                      ...
                      if (!mounted) return;
                      // PERBAIKAN: Gunakan fungsi Dialog baru, bukan Banner
                      _showSuccessDialog(transfer.name, finalAmountIDR, foreignAmount, currency);
                    } else {
                      if (!mounted) return;
  ...
  // --- PERBAIKAN: FUNGSI POPUP HIJAU BARU ---
  void _showSuccessDialog(String name, int amountIDR, double foreignAmount, String currency) {
    showDialog(
      context: context,
      barrierDismissible: false, // User tidak bisa menutup dengan klik luar
      builder: (BuildContext dialogContext) {
        
        // FITUR TIMER: Tutup otomatis setelah 3 detik
      ...
      // Aksi setelah popup tertutup: Kembali ke halaman sebelumnya (Home/History)
