...
class _KirimUangPageState extends State<KirimUangPage> {
            ...
            child: SingleChildScrollView(
              child: Column(
                children: [
                        ...
                        Expanded(
                          child: TextField(
                            ...
                            decoration: InputDecoration(
                              hintText: l10n.searchPhoneReceipt,
                  ...
                  const SizedBox(height: 20),
                  _buildSection("contacts", contacts, isContact: true, l10n: l10n),
                  const SizedBox(height: 20),
                  _buildSection("actions", _buildActionsList(l10n), l10n: l10n),
                ],
              ),
            ),
          ),
  ...
  List<Map<String, String>> _buildActionsList(AppLocalizations l10n) {
    return [
      {'label': l10n.sendToGroup, 'img': 'asset/ilogo1.png', 'action': 'group'},
      {'label': l10n.sendToFriend, 'img': 'asset/ilogo2.png', 'action': 'friend'},
      {'label': l10n.sendToBank, 'img': 'asset/ilogo3.png', 'action': 'bank'},
      {'label': l10n.sendToWallet, 'img': 'asset/ilogo4.png', 'action': 'ewallet'},
      {'label': l10n.sendCashCode, 'img': 'asset/ilogo5.png', 'action': 'cashcode'},
      {'label': l10n.cashPull, 'img': 'asset/ilogo6.png', 'action': 'cashpull'},
      {'label': l10n.sendToEmail, 'img': 'asset/ilogo7.png', 'action': 'email'},
      {'label': l10n.scanQrCode, 'img': 'asset/ilogo8.png', 'action': 'qr'},
      {'label': l10n.sendToChat, 'img': 'asset/ilogo5.png', 'action': 'chat'},
    ];
  }
