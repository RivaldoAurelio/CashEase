...
class _BeneficiaryPageState extends State<BeneficiaryPage> {
  ...
  final List<Beneficiary> _beneficiaries = [
    Beneficiary(name: 'John Doe', bankName: 'Bank BCA', accountNumber: '1234567890', logoAssetPath: 'asset/elogo1.png', alias: 'Ayah'),
    Beneficiary(name: 'Jane Smith', bankName: 'Bank Mandiri', accountNumber: '0987654321', logoAssetPath: 'asset/elogo2.png', alias: 'Ibu'),
    Beneficiary(name: 'Michael Johnson', bankName: 'Bank BNI', accountNumber: '1122334455', logoAssetPath: 'asset/elogo5.png', alias: 'Toko'),
    Beneficiary(name: 'Emily Davis', bankName: 'Dana', accountNumber: '08123456789', logoAssetPath: 'asset/elogo3.png'),
  ];
  ...
  void _deleteBeneficiary(int index) {
    // 🔹 Ambil l10n untuk dialog
    final l10n = AppLocalizations.of(context)!;
    showDialog(
      context: context,
      builder: (context) => AlertDialog(
        title: Text(l10n.delete), // "Hapus"
        content: Text('${l10n.deleteConfirmation} ${_beneficiaries[index].name}?'),
        actions: [
          TextButton(
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      appBar: AppBar(
        title: Text(
          l10n.menuBeneficiary, // "Daftar Penerima"
    ...
    return Container(
      ...
      child: TextField(
        ...
        decoration: InputDecoration(
          hintText: l10n.searchHint, // "Cari nama, alias..."
        ...
        trailing: Row(
          ...
          children: [
            IconButton(
              ...
              onPressed: () => _addOrEditBeneficiary(beneficiary, _beneficiaries.indexOf(beneficiary)),
            ),
            IconButton(
              icon: Icon(Icons.delete, color: Colors.red.shade700, size: 20),
              onPressed: () => _deleteBeneficiary(_beneficiaries.indexOf(beneficiary)),
            ),
          ],
        ),
      ),
    ...
    return Center(
      child: Column(
        ...
        children: [
          ...
          Text(
            l10n.noBeneficiary, // "Belum Ada Penerima"
...
class _AddEditBeneficiaryPageState extends State<AddEditBeneficiaryPage> {
  ...
  void initState() {
    ...
    _aliasController = TextEditingController(text: widget.beneficiary?.alias ?? '');
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      appBar: AppBar(
        title: Text(
          // Gunakan Key untuk judul
          widget.beneficiary == null ? l10n.addBeneficiary : l10n.editBeneficiary,
          style: const TextStyle(color: Colors.white, fontWeight: FontWeight.bold),
        ),
        backgroundColor: Colors.deepPurple,
        iconTheme: const IconThemeData(color: Colors.white),
        ...
        child: ListView(
          ...
          children: [
            DropdownButtonFormField<String>(
              ...
              validator: (value) => value == null ? l10n.failed : null,
            ),
            const SizedBox(height: 20),
            TextFormField(
              controller: _accountNumberController,
              decoration: InputDecoration(
                labelText: l10n.accountNumber, // "Nomor Rekening"
                border: const OutlineInputBorder(),
              ),
              keyboardType: TextInputType.number,
              validator: (value) => value!.isEmpty ? l10n.failed : null,
            ),
            const SizedBox(height: 20),
            TextFormField(
              controller: _nameController,
              decoration: InputDecoration(
                labelText: l10n.firstName, // Reuse "Nama" / First Name logic
                border: const OutlineInputBorder(),
              ),
              validator: (value) => value!.isEmpty ? l10n.failed : null,
            ),
            ...
            TextFormField(
              ...
              decoration: const InputDecoration(
                labelText: 'Alias (Opsional)', // Bisa ditambah di ARB
                border: OutlineInputBorder(),
              ),
            ),
