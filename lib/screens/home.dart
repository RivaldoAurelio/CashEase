...
// Import FirestoreService & Localization
...
class _HomeState extends State<Home> {
  ...
  // 🔹 UPDATE: Mengirim parameter ke QrisPage
  List<Widget> get _pages => [
        ...
        QrisPage(
          phoneNumber: widget.phoneNumber,
          onPaymentSuccess: () {
            // Logika: Pindah ke Tab History (index 1) setelah bayar sukses
            setState(() {
              _selectedIndex = 1;
            });
          },
    ...
    return Drawer(
      child: ListView(
        ...
        children: [
          ...
          // ITEM TAGIHAN DIHAPUS DARI SINI
          _buildDrawerItem(
  ...
  Widget _buildBottomNavBar(AppLocalizations l10n) {
    return BottomNavigationBar(
      ...
      items: [
        ...
        BottomNavigationBarItem(icon: const Icon(Icons.person), label: "Me"),
      ],
    );
  }
}
