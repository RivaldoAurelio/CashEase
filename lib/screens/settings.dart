...
class _SettingsPageState extends State<SettingsPage> {
        ...
        return Container(
          ...
          child: Column(
            ...
            children: [
              ...
              _buildLanguageItem(languageProvider, 'Bahasa Indonesia', 'id'),
              _buildLanguageItem(languageProvider, 'English', 'en'),
              _buildLanguageItem(languageProvider, '日本語 (Japanese)', 'ja'),
              _buildLanguageItem(languageProvider, '한국어 (Korean)', 'ko'),
              _buildLanguageItem(languageProvider, '中文 (Chinese)', 'zh'),
            ],
          ),
        );
      },
  ...
  Widget _buildLanguageItem(LanguageProvider provider, String name, String code) {
    return ListTile(
      leading: const Icon(Icons.language, color: Colors.deepPurple),
      title: Text(name),
      onTap: () {
        // 🔹 UBAH BAHASA DENGAN PROVIDER - INI OTOMATIS UPDATE UI
      ...
      body: ListView(
        children: [
          ...
          _buildSettingsTile(
            ...
            subtitle: languageProvider.getLanguageName(languageProvider.currentLocale.languageCode), // Tampilkan bahasa yang sedang dipilih
          ...
          // --- ITEM YANG DIHAPUS: Pusat Bantuan ---
          _buildSettingsTile(
